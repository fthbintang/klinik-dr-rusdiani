                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nik" id="nik"
                            ...
                            value="{{ old('nik', $pasien->nik) }}" placeholder="NIK..." readonly>
                        @error('nik')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="agama" id="agama"
                            class="form-select @error('agama') is-invalid @enderror" disabled>
                            ...
                            <option value="Buddha" {{ old('agama', $pasien->agama) == 'Buddha' ? 'selected' : '' }}>
                                Buddha
                            </option>
