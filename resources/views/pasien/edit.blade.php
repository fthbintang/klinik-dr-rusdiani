            ...
            <form action="{{ route('pasien.update', $pasien->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-3">
                    ...
                    <small class="form-text text-muted">
                        <b>Password</b> pasien hanya dibuat saat pendaftaran pertama kali. Mengubah nama panggilan tidak
                        akan
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nik" id="nik"
                        ...
                        placeholder="NIK...">
                    <small class="form-text text-muted">
                        <b>Username</b> pasien hanya dibuat saat pendaftaran pertama kali. Mengubah NIK tidak akan
