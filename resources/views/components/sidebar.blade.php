            ...
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->is('dashboard/obat*') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        ...
                        <x-sidebar-sublink href="{{ route('obat_masuk.index') }}"
                            :active="request()->routeIs('obat_masuk.index')">
                            Obat Masuk
                        </x-sidebar-sublink>
                        <x-sidebar-sublink href="{{ route('obat_keluar.index') }}"
                            :active="request()->routeIs('obat_keluar.index')">
                            Obat Keluar
                        </x-sidebar-sublink>
                    </ul>
                </li>
